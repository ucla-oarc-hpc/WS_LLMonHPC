...
- 🔒 **Data privacy** - Keep sensitive data on Hoffman2
  - Generate and analyze data locally 
- ⚙️ **Customization** - Control over model implementation
  - Run specialized models for research domains
  - Fine-tune models on your own datasets
- 🔍 **Research control** - Full experimental flexibility
  - Adjust parameters, compare variations, ensure reproducibility
...
- **Where LLMs on HPC Fit:**
  ...
  - Generate data on Hoffman2 
    - Then analyze with LLMs directy
...
::: {.callout-tip} 
Example file: langchain_RAG.py demonstrates a complete RAG workflow for medical data analysis 
::: 
::: {.callout-warning} 
...
::: {.callout-tip} 
Example file: llamaindex_RAG.py shows a complete workflow from documents to answers 
::: 
::: 
:::: 
:::
...
Please fill out our [Workshop Feedback Form](https://app.smartsheet.com/b/form/f5710344461f4d93ace0db9ea579ff04)
:::
:::
::: {.column}
::: { style="text-align: center" }
